...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"/Users/teejay/Documents/Udemy_Code/Machine_Learning_Projects/heart_disease_project/env/bin/python",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/Users/builder/cbouss/perseverance-python-buildout/croot/contourpy_1701814001737/work/.mesonpy-24lccgpw/build/lib/contourpy/util",
        source_dir=r"/Users/builder/cbouss/perseverance-python-buildout/croot/contourpy_1701814001737/work/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/Users/builder/cbouss/perseverance-python-buildout/croot/contourpy_1701814001737/work/.mesonpy-24lccgpw/build/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
